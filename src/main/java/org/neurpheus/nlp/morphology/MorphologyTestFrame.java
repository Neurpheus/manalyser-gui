 ...
 *
 * Created on 5 pa�dziernik 2006, 08:58
 */
...
public class MorphologyTestFrame extends javax.swing.JFrame {
    ...
    public static String dirPath = "c:\\projekty\\neurpheus\\manalyser-data\\dictionaries";
    ...
    private void initComponents() {
        ...
        jAnanlysisResult.setFont(new java.awt.Font("Arial", 0, 10)); // NOI18N
        ...
        jBuildButton.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        jBuildButton.setForeground(new java.awt.Color(0, 51, 51));
        ...
        jArchitectureName.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .add(org.jdesktop.layout.GroupLayout.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .add(jPanel2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.TRAILING)
                    .add(org.jdesktop.layout.GroupLayout.LEADING, jTabbedPane3, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
                    .add(org.jdesktop.layout.GroupLayout.LEADING, jPanel2Layout.createSequentialGroup()
                        ...
                        .add(jPanel2Layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING, false)
                            .add(jBuildButton, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .add(jOpenDirectoryButton, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, org.jdesktop.layout.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
        ...
        while (tokenizer.hasMoreTokens()) {
            ...
            if (token.length() > 0) {
                ...
                try {
                    ...
                    Logger.getLogger(MorphologyTestFrame.class.getName()).
                            log(Level.SEVERE, null, ex);
                }
                if (result.size() > 0) {
                    boolean show = true;
                    if (jShowOnlyUncertainResults.isSelected()) {
                        MorphologicalAnalysisResult mres = (MorphologicalAnalysisResult) result.get(
                                0);
                        show = !mres.isCertain();
                    }
                    if (show) {
                        ...
                        for (final Iterator it = result.iterator(); it.hasNext();) {
                            MorphologicalAnalysisResult mres = (MorphologicalAnalysisResult) it.
                                    next();
...
// TODO add your handling code here:
    ...
    private void jOpenDirectoryButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jOpenDirectoryButtonActionPerformed
        ...
        fch.setFileFilter(new AnanlyserFileFilter("MySpell dictionary file (*.dic)",
                                                  new String[]{".dic"}));
        ...
        private void jBuildButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBuildButtonActionPerformed
            ...
            NeuralNetworkLearningProperties nnp = MorphologicalAnalyserBuilder.
                    getNeuralNetworkLearningProperties();
            ...
            nnp.setMaximumNumberOfTrainingExamples(Integer.parseInt(
                    jMaximumNumberOfTrainingExamples.getText()));
            ...
            nnp.setLearningFactorMultiplerByNumberOfEpochs(Double.parseDouble(
                    jLearningFactorMultipler2.getText()));
        ...
        private void jOpenAnanlyserButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jOpenAnanlyserButtonActionPerformed
            ...
            fch.setFileFilter(new AnanlyserFileFilter("Morphological ananlysers (*.ana, *.anz)",
                                                      new String[]{".ana", ".anz"}));
            if (fch.showOpenDialog(this) == JFileChooser.APPROVE_OPTION) {
                File f = fch.getSelectedFile();
                String path = f.getAbsolutePath();
                ...
                jHypergraph.setEnabled(false);
                try {
                    analyser = (MorphologicalAnalyserImpl) FilePath2Object.readObject(path, path.
                                                                                      endsWith(
                                                                                              ".anz"));
                    ...
                    JOptionPane.showMessageDialog(this, e.getMessage(),
                                                  "Cannot open morphological analyser",
        ...
        private void jHypergraphActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jHypergraphActionPerformed
            if (analyser != null) {
                InflectionHypergraph ih = new InflectionHypergraph(analyser.getTree(), analyser.
                                                                   getIpb().
                                                                   getInflectionPatternsMap());
    ...
    private void openDefaultNeuralNetwork() {
        InputStream in = null;
        try {
            in = MorphologyTestFrame.class.getClassLoader().getResourceAsStream(
                    DEFAULT_NEURAL_NETWORK_RESOURCE);
            openNeuralNetwork(in);
        } catch (Exception ex) {
            Logger.getLogger(MorphologyTestFrame.class.getName()).log(Level.SEVERE,
                                                                      "Cannot open default neural network from resource " + DEFAULT_NEURAL_NETWORK_RESOURCE,
                                                                      ex);
        } finally {
            if (in != null) {
                try {
    ...
    private void openNeuralNetwork(final InputStream in) throws ParserConfigurationException,
    ...
    private void openNerualNetwork(final String path) {
        ...
        try {
            ...
            Logger.getLogger(MorphologyTestFrame.class.getName()).log(Level.SEVERE,
                                                                      "Cannot open neural network from file " + path,
                                                                      ex);
        } finally {
            if (in != null) {
                try {
        ...
        private void jOpenArchitectureActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jOpenArchitectureActionPerformed
            ...
            fch.setFileFilter(new AnanlyserFileFilter("Artificail neural network file (*.ann)",
                                                      new String[]{".ann"}));
            if (fch.showOpenDialog(this) == JFileChooser.APPROVE_OPTION) {
                File f = fch.getSelectedFile();
                String path = f.getAbsolutePath();
...
private void jGenerateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jGenerateActionPerformed
    ...
    try {
        analyser.setUseNeuralNetwork(jUseNeuralNetwork.isSelected());
        analyser.setUseBaseFormsDictionary(jUseBaseFormsDictionary.isSelected());
        GrammaticalProperties grammaticalProperties = analyser.getTagset().getGrammaticalProperties(
                mark);
